...
public class ArchiveCustomer {
    ...
    public ArchiveCustomer(Customer customer) {
        this.name = customer.getName();
        this.phone = customer.getPhone();
        this.city = customer.getCity();
        this.type = customer.getType();
        this.timeToContact = customer.getTimeToContact();
        this.realtorID = customer.getRealtorID();
        this.location = customer.getLocation();
        this.formOfPayment = customer.getFormOfPayment();
        this.heatingLevel = customer.getHeatingLevel();
        this.shortDescription = customer.getShortDescription();
    }
    ...
    public String toString() {
        ...
        sb.append("📋 Информация о архивном клиенте:\n");
